...
const PapersDetails = () => {
  ...
  return (
    <>
    <div className='mt-32 w-11/12 max-w-maxContent mx-auto relative flex flex-col justify-center items-center'>
      <div>
      ...
      <div className='relative w-full flex flex-row flex-wrap gap-x-5 justify-center items-center  transition-all duration-300ms'>
      {
        !loading && papers?.length > 0 && (
          papers[0]?.content?.map((item, index) => (
            <div className='flex flex-col'>  
              <a href={item?.link} target='blank' className='text-tempDark'>
              ...
              <div onClick={() => savePapers(index)} className='mt-1 text-tempDark bg-tempPrimary p-2 rounded-t-none rounded-b-lg text-center mb-12'>
